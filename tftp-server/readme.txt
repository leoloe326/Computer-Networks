...
--------------------
1.A TFTP server(implemented over UDP) with protocol IETF RFC 1350 is implemented. The server transfers the files requested to the client.
2.The TFTP server is enabled for any size and any type of files.
3.The timeouts for the server are : Retransmission (100 ms) and closing connection (5 ms).
